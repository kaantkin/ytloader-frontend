...
function Download() {
    ...
    const serverURL = 'https://ytloader-backend-production-4ba1.up.railway.app/'; // Change this to your server - this is only for development/example
                                ...
                                if (value[5] === true && value[6] === true) {
                                    ...
                                    return (
                                        <tr>
                                            ...
                                            <td>{value[4]}</td>
                                            <td>{value[1]}</td>
                                            <td><a href={serverURL + 'videosaver?URL=' + encodeURIComponent(value[8]) + '&filename=' + encodeURIComponent(videoData["title"]) + '&format=' + value[4]  + '&mimeType=' + value[0]} target="_blank">Download</a></td>
                                        </tr>
                                    )
                                }
                            })
